...
class ReactorFluxWindow(QtWidgets.QWidget):
    def __init__(self, username, reactor_type, reactor_name, selected_channels, database_type):
        ...
        self.properties =[
            "flow (lpm)","Temperature","Pressure","SAG (mm)","Bundle weigh (kg)","Reactor flux",
            "Garter spring-1 location","Garter spring-2 location","Garter spring-3 location",
            "Garter spring-4 location","Slope"
    ]
  # Create main layout
